										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
													...
													<div class="menu-sub menu-sub-accordion">
														<div class="menu-item">
															<a class="menu-link active" href="../../demo14/dist/apps/ecommerce/sales/listing.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
						...
						<div class="d-flex flex-column flex-column-fluid container-fluid">
							...
							<div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
								...
								<div class="page-title d-flex flex-column me-3">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder my-1 fs-3">Orders Listing</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
								...
								<div class="card card-flush">
									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
											...
											<!--begin::Add product-->
											<a href="../../demo14/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Add Order</a>
											<!--end::Add product-->
										</div>
										<!--end::Card toolbar-->
									</div>
											...
											<tbody class="fw-bold text-gray-600">
												...
												<tr>
													...
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13275</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Robert Doe</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<td class="text-end pe-0">
														<span class="fw-bolder">$466.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13276</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Ethan Wilder</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13277</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Dan Wilson</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$440.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13278</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13279</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Mikaela Collins</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13280</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Emma Smith</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$409.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13281</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Emma Bold</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$418.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-03-22">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13282</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Brian Cox</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$77.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13283</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$139.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13284</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Neil Owen</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$314.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13285</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Olivia Wild</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$319.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-03-17">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13286</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$425.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13287</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$258.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13288</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Francis Mitcham</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$26.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13289</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$402.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-03-13">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13290</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Max Smith</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13291</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Ana Crown</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13292</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$259.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13293</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13294</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$276.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13295</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$333.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-03-08">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13296</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">John Miller</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$400.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13297</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13298</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$224.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13299</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Lucy Kunic</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13300</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Melody Macy</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13301</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$279.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13302</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder">Sean Bean</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$323.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13303</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13304</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$71.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-27">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13305</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$423.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-24">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13306</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$478.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13307</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$320.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13308</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$17.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-20">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13309</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$419.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13310</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$394.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-18">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13311</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$109.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-20">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13312</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$100.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13313</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$245.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13314</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$455.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13315</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13316</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$56.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13317</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13318</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$462.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13319</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$401.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13320</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$486.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13321</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$453.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13322</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$158.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-07">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13323</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$463.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-08">
												...
												<tr>
													...
													<!--begin::Order ID=-->
													<td data-kt-ecommerce-order-filter="order_id">
														<a href="../../demo14/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bolder">13324</a>
													</td>
													<!--end::Order ID=-->
													<!--begin::Customer=-->
													<td>
													...
													<!--begin::Total=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">$380.00</span>
													</td>
													<!--end::Total=-->
													<!--begin::Date Added=-->
													<td class="text-end" data-order="2022-02-06">
