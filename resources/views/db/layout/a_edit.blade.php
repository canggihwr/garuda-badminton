						...
						<div class="d-flex flex-column flex-column-fluid container-fluid">
							...
							<div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
								...
								<div class="page-title d-flex flex-column me-3">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder my-1 fs-1">Edit Admin</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-500">Edit Admin</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
							...
							<div class="content flex-column-fluid" id="kt_content">
								<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="/dashboard/peralatan">
									<!--begin::Aside column-->
									...
									<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<div class="mb-10 fv-row">
													<!--begin::Label-->
													<label class="required form-label">Nama Admin</label>
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" name="category_name" class="form-control mb-2" placeholder="Nama" value="Imam Firmansyah" />
													<!--end::Input-->
												</div>
												<!--end::Input group-->
                                                <!--begin::Input group-->
												<div class="mb-10 fv-row">
													...
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" name="category_name" class="form-control mb-2" placeholder="Email" value="imamfirman15@gmail.com" />
													<!--end::Input-->
												</div>
												<!--end::Input group-->
												<!--begin::Input group-->
												<div class="mb-10 fv-row">
													...
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" name="price" class="form-control mb-2" placeholder="Username" value="imam" />
													<!--end::Input-->
												</div>
												<!--end::Input group-->
                                                <!--begin::Input group-->
												<div class="mb-10 fv-row">
													...
													<!--begin::Editor-->
													<div class="">
                                                        <input type="password" name="price" class="form-control mb-2" placeholder="Password" value="ahahahaa" />
												...
												<div class="mb-10 fv-row">
													...
													<!--begin::Editor-->
													<div class="">
                                                        <input type="text" name="price" class="form-control mb-2" placeholder="No Hp" value="087759742907" />
												...
												<div>
													...
													<div class="min-h-150px mb-2">
														<textarea class="form-control" placeholder="Alamat" id="floatingTextarea2" style="height: 120px">Jl. Panji Asmara no.10, Kekalik Jaya</textarea>
										...
										<div class="d-flex justify-content-end">
											...
											<button type="submit" id="kt_ecommerce_add_category_submit" class="btn btn-primary">
												<span class="indicator-label">Upate</span>
