										...
										<div class="tab-pane fade show active" id="kt_ecommerce_sales_order_summary" role="tab-panel">
												...
												<div class="card card-flush py-4 flex-row-fluid overflow-hidden">
													...
													<div class="card-header">
														<div class="card-title">
															<div style="white-space: nowrap">
																<h2 style="white-space: nowrap">Detail Pemesanan 
															...
															@If($penyewaan->status == 'Menunggu Pembayaran')
															<!--begin::Input group-->
															<div class="mb-10 fv-row" id="kt_ecommerce_add_product_discount_percentage" style="margin-left: 25rem">
																<!--begin::Label-->
																...
																<div class="d-flex flex-column text-center">
																	...
																	<!--end::Svg Icon-->
																	<span class="fw-bolder fs-3x" id="demo">--:--:--</span>
																		<input type="hidden" id="getdate" value="{{ $penyewaan->created_at->format('d M, Y H:i:s') }}" />
																	</div>
																</div>
																<!--end::Slider-->
																<!--begin::Description-->
																<div class="text-muted fs-7">Harap melakukan pembayaran sebelum waktu yang tertera.</div>
																<!--end::Description-->
															</div>
															<!--end::Input group-->
															@endif
													...
													<script>
														...
														var get = document.getElementById("getdate").value
														var countDownDate = new Date(document.getElementById("getdate").value).getTime() + 71280000;
														// alert(countDownDate);
														// document.getElementById("getdate").innerHTML = countDownDate;
