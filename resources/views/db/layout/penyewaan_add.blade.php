											...
											<div class="card-body pt-0">
												<div class="d-flex flex-column gap-10">
													...
													<div class="fv-row">
														...
														<!--end::Label-->
														<!--begin::Select2-->
														<select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Pilih lapangan" name="payment_method" id="kt_ecommerce_edit_order_payment">
															<option></option>
													...
													<div class="fv-row">
														...
														<div class="position-relative d-flex align-items-center">
															...
															<!--end::Svg Icon-->
															<input class="form-control form-control ps-12" name="date" placeholder="Pilih tanggal" id="kt_datepicker_1" />
														</div>
													</div>
													<!--end::Input group-->
													<!--begin::Input group-->
													<div class="fv-row">
														...
														<div class="position-relative d-flex align-items-center">
															...
															<!--end::Svg Icon-->
															<input class="form-control form-control ps-12" name="date" placeholder="Pilih waktu" id="kt_datepicker_8" />
														</div>
														<!--end::Editor-->
													</div>
													<!--end::Input group-->
...
<div data-kt-buttons="true">
    ...
    <label class="btn btn-outline btn-outline-dashed d-flex flex-stack text-start p-6 mb-5">
        ...
        <div class="d-flex align-items-center me-2">
            ...
            <div class="form-check form-check-custom form-check-solid form-check-primary me-6">
                <input class="form-check-input" type="radio" name="plan" value="paket 1"/>
            </div>
            <!--end::Radio-->
        ...
        <div class="ms-5">
            ...
            <span class="fs-7 opacity-50">/
                <span data-kt-element="period">Jam</span>
            </span>
        </div>
        <!--end::Price-->
    </label>
    ...
    <label class="btn btn-outline btn-outline-dashed d-flex flex-stack text-start p-6 mb-5 active">
        ...
        <div class="d-flex align-items-center me-2">
            <!--begin::Radio-->
            <div class="form-check form-check-custom form-check-solid form-check-primary me-6">
                <input class="form-check-input" type="radio" name="plan" checked="checked" value="paket 2"/>
            </div>
            <!--end::Radio-->
            ...
            <div class="flex-grow-1">
                <h2 class="d-flex align-items-center fs-4 fw-bolder flex-wrap">
                    Paket 2 Jam
                    <span class="badge badge-light-success ms-2 fs-7">Paling Populer</span>
                </h2>
            </div>
            <!--end::Info-->
        </div>
        ...
        <div class="ms-5">
            ...
            <span class="fs-7 opacity-50">/
                <span data-kt-element="period">2 Jam</span>
            </span>
        </div>
        <!--end::Price-->
    </label>
    ...
    <label class="btn btn-outline btn-outline-dashed d-flex flex-stack text-start p-6">
        ...
        <div class="d-flex align-items-center me-2">
            <!--begin::Radio-->
            <div class="form-check form-check-custom form-check-solid form-check-primary me-6">
                <input class="form-check-input" type="radio" name="plan" value="paket 3"/>
            </div>
            <!--end::Radio-->
        ...
        <div class="ms-5">
            ...
            <span class="fs-7 opacity-50">/
                <span data-kt-element="period">3 Jam</span>
            </span>
        </div>
        <!--end::Price-->
    </label>
