                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="px-9 pt-7 card-rounded h-275px w-100 bg-primary">
                            ...
                            <div class="d-flex flex-stack">
                                <h3 class="m-0 text-white fw-bolder fs-3">Paket 1</h3>
                                <div class="ms-1">
                                    <!--begin::Menu-->
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/dashboard/paket/edit" class="menu-link px-3">Edit Paket</a>
                                        </div>
                                        <!--end::Menu item-->
                                        
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="/dashboard/paket" class="menu-link px-3">Hapus Paket</a>
                                        </div>
                                        <!--end::Menu item-->
                            ...
                            <div class="d-flex text-center flex-column text-white pt-8">
                                ...
                                <span class="fw-bolder fs-2x pt-1">Rp.25,000</span>
                            </div>
                            <!--end::Balance-->
                        </div>
                        <!--end::Header-->
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <div class="d-flex align-items-center flex-wrap w-100">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="fw-bolder fs-5 text-gray-800 pe-1">1 Jam</div>
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="px-9 pt-7 card-rounded h-275px w-100 bg-danger">
                            <!--begin::Heading-->
                            <div class="d-flex flex-stack">
                                <h3 class="m-0 text-white fw-bolder fs-3">Paket 2</h3>
                                <div class="ms-1">
                                    <!--begin::Menu-->
                            ...
                            <div class="d-flex text-center flex-column text-white pt-8">
                                <span class="fw-bold fs-7">Harga</span>
                                <span class="fw-bolder fs-2x pt-1">Rp.45,000</span>
                            </div>
                            <!--end::Balance-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -100px">
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <div class="d-flex align-items-center flex-wrap w-100">
                                    ...
                                    <!--begin::Label-->
                                    <div class="d-flex align-items-center">
                                        <div class="fw-bolder fs-5 text-gray-800 pe-1">2 Jam</div>
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                                        <span class="svg-icon svg-icon-5 svg-icon-success ms-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <rect opacity="0.5" x="13" y="6" width="13" height="2" rx="1" transform="rotate(90 13 6)" fill="currentColor" />
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="px-9 pt-7 card-rounded h-275px w-100 bg-success">
                            <!--begin::Heading-->
                            <div class="d-flex flex-stack">
                                <h3 class="m-0 text-white fw-bolder fs-3">Paket 3</h3>
                                <div class="ms-1">
                                    <!--begin::Menu-->
                            ...
                            <div class="d-flex text-center flex-column text-white pt-8">
                                <span class="fw-bold fs-7">Harga</span>
                                <span class="fw-bolder fs-2x pt-1">Rp.65,000</span>
                            </div>
                            <!--end::Balance-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1" style="margin-top: -100px">
                            ...
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <div class="d-flex align-items-center flex-wrap w-100">
                                    ...
                                    <!--begin::Label-->
                                    <div class="d-flex align-items-center">
                                        <div class="fw-bolder fs-5 text-gray-800 pe-1">3 Jam</div>
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
                                        <span class="svg-icon svg-icon-5 svg-icon-success ms-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <rect opacity="0.5" x="13" y="6" width="13" height="2" rx="1" transform="rotate(90 13 6)" fill="currentColor" />
