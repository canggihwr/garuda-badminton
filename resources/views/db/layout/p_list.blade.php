												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="../../demo14/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Settlecock</a>
																<!--end::Title-->
															</div>
														</div>
													</td>
													...
													<td class="text-end pe-0">
														<span class="fw-bolder text-dark">Rp.12,000</span>
													</td>
													<!--end::Price=-->
													<!--begin::Status=-->
