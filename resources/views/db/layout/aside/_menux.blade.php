									...
									<div class="menu menu-column menu-rounded fw-bold fs-6" id="#kt_aside_menu" data-kt-menu="true">
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											<span class="menu-link">
												<span class="menu-icon">
													...
													<span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												<div class="menu-item">
													<a class="menu-link" href="/dashboard/penyewaan/add">
														...
														<span class="menu-title">Sewa Lapangan</span>
													</a>
												</div>
												<div class="menu-item">
													<a class="menu-link" href="/dashboard/penyewaan">
														...
														<span class="menu-title">History Penyewaan</span>
													</a>
												</div>
											</div>
										</div>
										...
										<div class="menu-item">
											<a class="menu-link" href="/dashboard/peralatan">
												...
												<span class="menu-title">Daftar Peralatan</span>
											</a>
										</div>
										<div class="menu-item">
