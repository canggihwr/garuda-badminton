...
<div class="content flex-column-fluid" id="kt_content">
    ...
    <div class="d-flex flex-wrap flex-stack pb-7">
        ...
        <div class="d-flex flex-wrap align-items-center my-1">
            <h3 class="fw-bolder me-5 my-1">Admin (3)</h3>
            <!--begin::Search-->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                            ...
                            <div class="symbol symbol-65px symbol-circle mb-5">
                                <img src="db/media//avatars/unnamed.jpg" alt="image" />
                            ...
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-0">Canggih Wahyu Rinaldi</a>
                            <!--end::Name-->
                            <!--begin::Position-->
                            <div class="fw-bold text-gray-400 mb-6">cwr@gmail.com</div>
                            <!--end::Position-->
                            <!--begin::Info-->
                            <div class="d-flex flex-center flex-wrap">
                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    <div class="fs-6 fw-bolder text-gray-700">Rp.104,560</div>
                ...
                <div class="col-md-6 col-xxl-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                            ...
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-0">Rangga Abdul Qodir</a>
                            <!--end::Name-->
                            <!--begin::Position-->
                            <div class="fw-bold text-gray-400 mb-6">rangga_aq@gmail.com</div>
                            <!--end::Position-->
                            <!--begin::Info-->
                            <div class="d-flex flex-center flex-wrap">
                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    <div class="fs-6 fw-bolder text-gray-700">Rp.90,000</div>
                                    <div class="fw-bold text-gray-400">Pendapatan</div>
                                </div>
                                <!--end::Stats-->
                                ...
                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    <div class="fs-6 fw-bolder text-gray-700">4</div>
                                    <div class="fw-bold text-gray-400">Transaksi</div>
                                </div>
                                <!--end::Stats-->
                ...
                <div class="col-md-6 col-xxl-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                            ...
                            <!--end::Avatar-->
                            <!--begin::Name-->
                            <a href="#" class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-0">M Alfandiansyah</a>
                            <!--end::Name-->
                            <!--begin::Position-->
                            <div class="fw-bold text-gray-400 mb-6">alfan@gmail.com</div>
                            <!--end::Position-->
                            <!--begin::Info-->
                            <div class="d-flex flex-center flex-wrap">
                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    <div class="fs-6 fw-bolder text-gray-700">Rp.54,000</div>
                                    <div class="fw-bold text-gray-400">Pendapatan</div>
                                </div>
                                <!--end::Stats-->
                                <!--begin::Stats-->
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="kt_project_users_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bolder">
                            ...
                            <thead class="fs-7 text-gray-400 text-uppercase">
                                <tr>
                                    <th class="min-w-250px">Nama Admin</th>
                                    <th class="min-w-150px">No. HP</th>
                                    <th class="min-w-90px">Alamat</th>
                            ...
                            <tbody class="fs-6">
                                <tr>
                                    ...
                                    <td>083199487686</td>
                                    <td>Kekalik Mataram</td>
                                    <td>
                                        <span class="badge badge-light-success fw-bolder px-4 py-3">Admin</span>
                                    </td>
                                    <td class="text-end">
