						...
						<div class="d-flex flex-column flex-column-fluid container-fluid">
							...
							<div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
								...
								<div class="page-title d-flex flex-column me-3">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder my-1 fs-1">Tambah Admin</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-500">Tambah Admin</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<div class="mb-10 fv-row">
													...
													<!--end::Label-->
													<!--begin::Input-->
													<input type="text" name="category_name" class="form-control mb-2" placeholder="Email" value="" />
													<!--end::Input-->
												</div>
												<!--end::Input group-->
												<!--begin::Input group-->
												...
												<div>
													...
													<div class="min-h-150px mb-2">
														<textarea class="form-control" placeholder="Alamat" id="floatingTextarea2" style="height: 120px"></textarea>
