					...
					<div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="?page=documentation/getting-started" class="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Documentation &amp; Videos</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="?page=documentation/base/utilities" class="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Plugins &amp; Components</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="?page=layout-builder" class="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Layout Builder</a>
									<!--end::Title-->
									<!--begin::Description-->
						...
						<div class="d-flex align-items-center mb-7">
							...
							<div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
								...
								<div class="d-flex flex-column me-2 me-lg-5">
									<!--begin::Title-->
									<a href="?page=documentation/getting-started/changelog" class="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">What's New</a>
									<!--end::Title-->
									<!--begin::Description-->
