...
<body>	
			...
			<div class="row">
				<div class="col-12">
					<nav class="navbar navbar-expand-lg navbar-light bg-light mx-lg-0">
						<a class="navbar-brand" href="index.html"><img src="{{ asset('v2/img/logo.png') }}" alt=""></a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 offset-md-1 order-first order-md-last mb-4 mb-md-0">
					<div class="img-wrap">
						<img src="{{ asset('v2/img/1.svg') }}" alt="">
					</div>
				</div>
			</div>	
		</div>	
					...
					<div class="video-section video-shadow">
						<figure class="vimeo"> 
							<a href="https://player.vimeo.com/video/239566739">
								<img src="{{ asset('v2/img/video.jpg') }}" alt="image"/>
							</a>
						</figure>
					</div>
				</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-3">
					<div class="contact-det text-center">
						<img src="{{ asset('v2/img/contact-1.svg') }}" alt="">
						<h6>Phone</h6>
						<p>+54 12 346 7826</p>
					</div>
				</div>
				<div class="col-md-3 mt-4 mt-md-0">
					<div class="contact-det text-center">
						<img src="{{ asset('v2/img/contact-2.svg') }}" alt="">
						<h6>Email</h6>
				...
				<div class="col-md-3 mt-4 mt-md-0">
					<div class="contact-det text-center">
						<img src="{{ asset('v2/img/contact-3.svg') }}" alt="">
						<h6>Address</h6>
    ...
    <!-- JAVASCRIPT
    ================================================== -->
    <script src="{{ asset('v2/js/jquery-3.2.1.min.js') }}"></script>
    <script src="{{ asset('v2/js/popper.min.js') }}"></script> 
    <script src="{{ asset('v2/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('v2/js/plugins.js') }}"></script> 
    <script src="{{ asset('v2/js/chart-custom.js') }}"></script>  
    <script src="{{ asset('v2/js/particles.js') }}"></script> 
